...
public class Chef{
    ...
    public static void cook(String chef, String waiter, String customer, String courseName) {
        Random random = new Random();
        System.out.println("Chef " + chef + " is cooking " + courseName);

        //alternate the waiter
        System.out.println("Waiter " + waiter + " is serving Customer " + customer + ": " + courseName);
        try {
            Thread.sleep(random.nextInt(COOKING_SERVING_TIME));
        } catch (InterruptedException e) {
        }
        Customer.eating(customer,courseName);

...
public class Waiter implements Runnable {
	 ...
	 *            name of the waiter
	 * @param customerNames
	 *            names of Customers served by the Waiter
	 * @param courses
	 *            multi-dimensional array of courses for each Customer of this
	 *            Waiter.(courses[i][j] has the j-th course for the i-th Customer of
	 *            this Waiter)
	 */
	...
	/**
	 * For each customer, a thread on this Waiter object serves the three courses in
	 * the correct order by calling the serve() method in the corresponding Table,
